...
// WebGL2 raymarch "hive" shader (adapted to this project's plain-JSX + CSS stack —
// original was a .tsx Next client component). Pure WebGL2, no deps.
// Renders a full-bleed animated canvas; fills its positioned parent.
...
export default function ShaderDemo() {
  ...
  useEffect(() => {
    ...
    if (!gl) { console.error('WebGL2 is not supported in this browser.'); return; }
  ...
  return <canvas ref={ref} className="aurora-canvas" style={{ background: '#000' }} />;
}
