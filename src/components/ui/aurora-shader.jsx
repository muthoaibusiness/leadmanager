...
// Interactive WebGL "Volumetric Aurora" background (adapted to this project's
// plain-JSX + CSS stack — original was .tsx/Tailwind). Pure WebGL, no deps.
// Props: flowSpeed, colorIntensity, noiseLayers, mouseInfluence.
